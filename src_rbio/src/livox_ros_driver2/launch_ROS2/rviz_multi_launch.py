...
def generate_launch_description():
    ...
    # Replace the zero pose with the measured top LiDAR mount transform.
    tf_livox_to_top = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        name='livox_to_livox_top',
        arguments=['0', '0', '0', '0', '0', '0', '1', 'livox_frame', 'livox_top']
    )
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
            'rviz',
            default_value='false',
            description='Start RViz display for raw Livox topics'
        ),
        imu_driver,
        livox_driver,
        livox_rviz,
