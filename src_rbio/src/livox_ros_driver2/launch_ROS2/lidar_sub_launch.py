...
user_config_path = os.path.join(cur_config_path, 'sub.json')
...
def generate_launch_description():
    ...
    imu_driver = Node(
        ...
        output='screen',
        arguments=['/dev/imu', '115200'],
        parameters=[myahrs_config_path],
    )
    ...
    tf_livox_to_rear = Node(
        ...
        arguments=[
            '-0.6', '-0.34', '-0.18',
            '0', '0', '-0.7071068', '0.7071068',
            'livox_frame', 'livox_rear',
        ],
    )

    tf_livox_to_top = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        name='livox_to_livox_top',
        arguments=[
            '0', '0', '0',
            '0', '0', '0', '1',
            'livox_frame', 'livox_top',
        ],
    )
