...
public:
    MotorNode() : Node("motor_node"), can_sock_(-1) {
        ...
        steer_angle_tracking_gain_ =
            this->declare_parameter<double>("steer_angle_tracking_gain", 1.5);
        max_steer_tracking_rate_ =
            this->declare_parameter<double>("max_steer_tracking_rate", 0.35);
...
private:
    ...
    double steer_angle_tracking_gain_ = 1.5;
    double max_steer_tracking_rate_ = 0.35;
