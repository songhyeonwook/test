...
: iMyAhrsPlus(port, baud_rate), Node("myahrs_ros2")
{
  ...
  this->declare_parameter("linear_acceleration_stddev", 0.026831);
  this->declare_parameter("angular_velocity_stddev", 0.002428);
  this->declare_parameter("magnetic_field_stddev", 0.00000327486);
  this->declare_parameter("orientation_stddev", 0.002143);
