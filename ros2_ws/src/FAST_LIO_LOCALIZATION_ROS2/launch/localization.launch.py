...
def generate_launch_description():
    ...
    default_rviz_config_path = '/home/test/Desktop/fastlio_localization.rviz'
    default_map_yaml_path = '/home/test/ros2_ws/src/navigation2/nav2_map_server/map/scans_new.yaml'
    ...
    tf_2d_bridge_node = Node(
        package='fast_lio_localization',
        executable='tf_2d.py',   # entry point면 tf_2d_bridge 로 바꿔
        name='tf_2d_bridge',
        parameters=[
            {'use_sim_time': use_sim_time},
            {'parent_3d': 'map'},
